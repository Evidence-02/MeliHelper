...
namespace Celeste.Mod.MeliHelper
{
    class InteractionController
    {
        ...
        public static void ActivateBlockDash(DashBlock block, Entity collide_entity)
        {
            if (block != null && collide_entity != null)
                block.Break(collide_entity.Center, collide_entity.Center - block.Center, true, true);
        }

        public static void ActivateBlockFalling(FallingBlock block, Entity entity)
        {
            if (!block.Triggered)
            {
        ...
        public static void ActivateBlockZipMover(ZipMover block, Entity entity)
        {
        ...
        public static void ActivateBlockMove(MoveBlock block, Entity entity)
        {
            block.OnStaticMoverTrigger(null);
        }

        public static void ActivateBlockTempleSwap(SwapBlock block, Entity entity)
        {
            swapblockOnDash.Invoke(block, new object[] { entity.Center });
        }

        public static void ActivateBlockTempleCracked(TempleCrackedBlock block, Entity entity)
        {
        ...
        public static void ActivateBlockFarewellLightningBreaker(LightningBreakerBox block, Entity entity, Vector2 speed)
        {
            Level level = block.SceneAs<Level>();
            Player player = level.Tracker.GetEntity<Player>();
            if (player != null)
        ...
        public static void ImitateSummitGemBounce(SummitGem gem, Player player, Vector2 speed)
        {
            ...
            Vector2 player_speed_old = player.Speed;
            player.Speed = speed;
            player.Center = gem.Center - player.Speed / 2;
        ...
        public static void OshiroBounce(AngryOshiro boss_oshiro, Player player)
        {
        ...
        public static void SnowballBounce(Snowball snowball, Player player)
        {
